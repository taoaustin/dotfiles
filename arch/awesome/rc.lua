...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "j",
        function ()
            ...
            local num_clients = #awful.screen.focused().clients
            for i=1,num_clients-1,1 do
                awful.client.swap.byidx(-1)
            end
            awful.client.focus.byidx(-1)
        end,
        {description = "cycle active clients, counter-clockwise", group = "client"}),
    awful.key({ modkey, "Shift"   }, "k",
        ...
        {description = "cycle active clients, clockwise", group = "client"}
    ),
    ...
    awful.key({ modkey,           }, "l",     
        function () 
            if (awful.layout.get(awful.screen.focused()) == awful.layout.suit.tile.left) then
    ...
    awful.key({ modkey },            "r",     function () 
        local x = awful.screen.focused().mypromptpopup
        x.visible = true
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "n",
        function (c)
            ...
            -- minimized, since minimized clients can't have the focu s.
            c.minimized = true
        end ,
