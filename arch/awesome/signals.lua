...
client.connect_signal("request::titlebars", function(c)
	...
	local close_btn = wibox.container.background(awful.titlebar.widget.closebutton(c))
	...
	local min_btn = wibox.container.background(awful.titlebar.widget.minimizebutton(c))
	...
	local max_btn = wibox.container.background(awful.titlebar.widget.maximizedbutton(c))
